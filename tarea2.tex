    ...
    \begin{enumerate}
        ...
        \item {
            ...
            \begin{center}
             ...
             $\int_{1}^{8}\int_{0}^{4}\frac{1}{5}e^{\frac{u}{v}}dudv = (\frac{1}{5})(48\sqrt{e} - 8Ei(\frac{1}{2}) - 32 - \frac{5e^4 - 16Ei(4)}{2})$
        }
        ...
        \item {
            ...
            Transformamos a coordenadas esféricas, el jacobiano es $r^2\sin\theta$ y tenemos que $r^2 = x^2+y^2+z^2$
            Estamos considernado el solido entre dos esferas completas, así que podemos expresar la integral de la siguiente forma:		
				\[
                \int_{0}^{\sqrt{2}}{
                    \int_{0}^{2\pi}{
                        \int_{0}^{\pi}{
            ...
            Ya que las funciones son independientes unas de otras podemos resolver la integral como el producto de tres integrales independientes por una constante $k$:
			 \[
                (k)
           ...
           Por lo tanto, la masa del sólido es $ (4\pi k)\left(\frac{2^{\frac{5}{2}} - 1}{5}\right)$
